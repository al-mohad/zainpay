...
class BankTransferPaymentState extends State<BankTransferPayment>
  ...
  Future<CreateVirtualAccountResponse?> createVirtualAccount(
      ...
      await request.createVirtualAccount();

  Future<VirtualAccountBalanceResponse?> virtualAccountBalance(
          final CreateVirtualAccountRequest request) async =>
      await request.virtualAccountBalance(
    ...
    try {
      ...
      if (value != null && value.data != null) {
        if (value.data?.balanceAmount >= widget.amount) {
          ...
          // Recursive call to check balance again
          await checkVABalance();
        }
      }
    } catch (e) {
      if (mounted) {
  ...
  void reRouteToSuccess(isSuccessful) async => Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => SuccessfulPayment(
          paymentResponse: PaymentResponse(),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'NGN ${formatter.format(widget.amount)}',
                                style: blackTextStyle.copyWith(
                                  ...
                                  children: [
                                    Text('Make a bank transfer of ',
                                        style: blackTextStyle.copyWith(
                                            ...
                                            fontWeight: FontWeight.w400)),
                                    Text(
                                        'N${formatter.format(widget.amount.abs())}',
                                        style: blackTextStyle.copyWith(
                                            color: hexToColor(blackColor),
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500)),
